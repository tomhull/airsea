...
#' @examples
#' Csat(10, 35)  # 282.015 mmol m-3, saturation concentration at 10 degrees and 35 salinity
#' Csat(10, 35, "mll")  # 6.314767 ml/l kg-1 saturation concentration at 10 degrees and 35 salinity
#' Csat(10, 35, "umolkg")  # 274.6095 umol kg-1 saturation concentration at 10 degrees and 35 salinity
#' @export
...
#' @param S salinity
#'
#' @details Applies polynomial fits to empirical data where available (O2,CO2,N2O etc), or where this data is not available, uses the synthesis of Henry's law constants and temperature dependencies along with the salinity relationship from Johnson (2010) which in turn uses Rolf Sander's collection of Henry's law constants
...
## Salting out (or in for very small compounds) factor from empirical parametrisation by Johnson 2010
